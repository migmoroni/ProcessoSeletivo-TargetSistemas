...
# Esta é a resolução 2, não havendo ligação ao excercicio 3.
# Inicio do programa
# Extração dos dados dos arquivos .Json
data = extract_data_from_json_file('arquivos/mensal_estadual.json', "estado", "faturamento") # Extração apenas dos dados referente ao ex4
